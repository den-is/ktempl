...
func init() {
	...
	rootCmd.Flags().String("log-file", "", "Path to log file. Allowed values \"disabled\", \"stdout\", \"stderr\", \"path_to_log_file_dst\". Default \"disabled\".")
	rootCmd.Flags().String("log-level", "", "Minimum log message level to log. Default \"info\". Available levels \"trace,debug,info,warn,error,fatal,panic\"")
